...
def main():
    ...
    output_csv="./submission/ensemble_result.csv"
    ...
    weight_path_list.append("./model_weight/b5.pth")
    img_resize_list.append((456, 456))

    # model 2
    model_list.append(models.efficientnet_b5(weights="IMAGENET1K_V1"))
    weight_path_list.append("./model_weight/b5_pseudo.pth")
    img_resize_list.append((456, 456))

    # model 3
    model_list.append(models.efficientnet_b6(weights="IMAGENET1K_V1"))
    weight_path_list.append("./model_weight/b6.pth")
